...
public class SimulationManager : MonoBehaviour
{
    ...
    [Tooltip("Tiempo de cada paso de simulación (Δt) en segundos.")] // Los Tooltip muestran texto descriptivo breve cuando un usuario pasa el ratón sobre un elemento interactivo. ES MERAMENTE ESTÉTICO
    [Min(0.0001f)]
    ...
    // Eventos (Controla el tiempo de todo)
